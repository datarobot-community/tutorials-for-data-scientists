...
2. Once you have done that, start trying out pictures that really test the generalizability of your model. For example, do a search for pets in droid costumes, or products with droid themes like R2D2 mugs. Put these into your app and see how it performs!
