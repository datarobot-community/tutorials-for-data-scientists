...
2. Once you have done that, start trying out pictures that really test the generalizability of your model. For example, the author uploaded pictures of dogs wearing droid costumes and other not-quite-right images to see if the model would still perform. 
