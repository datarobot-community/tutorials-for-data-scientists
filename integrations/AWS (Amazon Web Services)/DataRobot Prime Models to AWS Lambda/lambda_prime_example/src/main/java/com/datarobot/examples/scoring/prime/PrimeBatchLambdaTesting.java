...
public class PrimeBatchLambdaTesting {
    ...
    public static void main(String[] args) {
        ...
        PrimeBatchLambdaExample test = new PrimeBatchLambdaExample();
        try {
            LinkedHashMap<String, String> jsonMap1 = objectMapper.readValue(testJson, new TypeReference<LinkedHashMap<String,String>>(){});
            LinkedHashMap<String, String> jsonMap2 = objectMapper.readValue(testJson, new TypeReference<LinkedHashMap<String,String>>(){});
